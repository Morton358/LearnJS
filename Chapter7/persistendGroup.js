...
// well suited for persistent use. Arrays have slice and concat methods,
// which allow us to easily create new arrays without damaging the old one.
// But Set, for example, has no methods for creating a new set with an item added
// or removed.
//
...
// member added, and leave the old one unchanged. Similarly, delete creates
...
// (though you’ll definitely want to use it internally). Instead,
// there is an empty instance, PGroup.empty, that can be used as a starting value.
//
